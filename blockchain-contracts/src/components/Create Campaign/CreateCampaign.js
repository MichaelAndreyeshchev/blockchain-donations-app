...
import style from '../Campaign Page/SpecificDonation.module.css';
import DiscussionBoard from '../Campaign Page/DiscussionBoard';
        ...
        <MuiThemeProvider>
          <React.Fragment>
            <main>
              ...
              >
                <div className={style['description-container']}>
                  ...
                  <p className={style['description-container__description']}>
                    Description of the campaign - how much money has been
                    raised, where does the money go, etc.
                  </p>
              ...
              <div
                className={style.container + ' ' + style['container--donors']}
              >
              ...
              <section
                className={
                  style.container + ' ' + style['discussion--container']
                }
              >
                <div>
