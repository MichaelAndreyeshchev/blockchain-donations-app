...
contract Cryptonate {
    ...
    constructor (uint _deadline, uint _minContribution, uint _goal) {
    ...
    function createSpendingRequest(uint _value, address _recipient, string memory _description) public adminOnlyCheck goalReachedCheck { // ARYAN
        // charity creates a spending request
    }
    
    function voteRequest(uint index) public goalReachedCheck { // BEN
